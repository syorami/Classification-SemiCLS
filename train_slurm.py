...
def train(args, cfg, labeled_trainloader, unlabeled_trainloader, test_loader,
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        meter_manager.register('x_data_time')
        meter_manager.register('u_data_time')
        end = time.time()
        model.train()
        ...
        for batch_idx in range(args.eval_step):
            ...
            mid = time.time()
            meter_manager.x_data_time.update(time.time() - end)
            ...
            meter_manager.u_data_time.update(time.time() - mid)
